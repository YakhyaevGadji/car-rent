            ...
            <div className="container">
                ...
                <ul className="advantage__list">
                    <li className="advantage__item">
                        <img className="advantage__img" src={icons.agreementIcon} alt="" />
                    ...
                    <li className="advantage__item">
                        <img className="advantage__img" src={icons.depoIcon} alt="" />
                    ...
                    <li className="advantage__item">
                        <img className="advantage__img" src={icons.likeIcon} alt="" />
